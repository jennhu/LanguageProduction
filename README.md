...
This repository contains scripts and stimuli for the experiments described in the paper ["Precision fMRI reveals that the language-selective network supports both phrase-structure building and lexical access during language production"](https://www.biorxiv.org/content/10.1101/2021.09.10.459596v3) (Hu, Small, et al. 2022). This `README` contains information about the design of the experiments, paths to the stimuli, and instructions for running the scripts.
